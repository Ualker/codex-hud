...
| 018 | chokidar 5 不支持 glob，session/snapshot watcher 为死代码（含跨午夜固化） | 高 | 已修复 | docs/issues/issue-018-chokidar5-glob-watchers-dead.md |
| 019 | rollout 单条坏 JSON 行导致解析永久失败 | 中 | 已修复 | docs/issues/issue-019-rollout-malformed-line-freeze.md |
